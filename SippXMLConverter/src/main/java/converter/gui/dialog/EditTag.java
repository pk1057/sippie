...
public class EditTag extends JDialog implements IOptionGUIElements, IConstants {
    ...
    private void makeLayout() {
        ...
        else if(tagName.equals("recvCmd"))
            add(pRecvCmd,BorderLayout.CENTER);
        else if(tagName.equals("label"))
            add(pLabel,BorderLayout.CENTER);
        else if(tagName.equals("Response Time Repartition")||tagName.equals("Call Length Repartition"))
        ...
        bApply.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(tagName.equals("pause")) {
                    temp.append("pause");
                    if(!tfMilli.getText().isEmpty())
                        temp.append(" milliseconds=\"").append(tfMilli.getText()).append("\"");
                    if(!tfVariable.getText().isEmpty())
                        temp.append(" variable=\"").append(tfVariable.getText()).append("\"");
                    if(!tfNext[2].getText().isEmpty())
                        temp.append(" next=\"").append(tfNext[2].getText()).append("\"");
                    ...
                    if(!cbSanityCheck.isSelected())
                        temp.append(" sanity_check=\"false\"");
                    if(cbCrlf[2].isSelected())
                        temp.append(" crlf=\"true\"");
                    if(!tfAddOptions[7].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions);
                    temp.append(" />");
                }
                else if(tagName.equals("Response Time Repartition")
                        ||tagName.equals("Call Time Repartition")) {
                    temp.append(tagName);
                    if(!tfValue.getText().equals(""))
                        temp.append(" value=\"").append(tfValue.getText()).append("\"");
                    temp.append(" />");
                }
                else if(tagName.equals("send")) {
                    temp.append("send");
                    if(!tfRetrans.getText().isEmpty())
                        temp.append(" retrans=\"").append(tfRetrans.getText()).append("\"");
                    if(!tfStartRtd[0].getText().isEmpty())
                        temp.append(" start_rtd=\"").append(tfStartRtd[0].getText()).append(" \"");
                    if(!tfRtd[0].getText().isEmpty())
                        temp.append(" rtd=\"").append(tfRtd[0].getText()).append("\"");
                    if(cbRepeatRtd[0].isSelected())
                        temp.append(" repeat_rtd=\"true\"");
                    if(cbCrlf[0].isSelected())
                        temp.append(" crlf=\"true\"");
                    if(!tfLost[0].getText().isEmpty())
                        temp.append(" lost=\"").append(tfLost[0].getText()).append("\"");
                    if(!tfNext[0].getText().isEmpty())
                        temp.append(" next=\"").append(tfNext[0].getText()).append("\"");
                    if(!tfTest[1].getText().isEmpty())
                        temp.append(" test=\"").append(tfTest[0].getText()).append("\"");
                    if(!tfCounter[0].getText().isEmpty())
                        temp.append(" counter=\"").append(tfCounter[0].getText()).append("\"");
                    if(!tfStartTxn.getText().isEmpty())
                        temp.append(" start_txn=\"").append(tfStartTxn.getText()).append("\"");
                    if(!tfAddOptions[0].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[0].getText());
                    temp.append(">");
                }
                else if(tagName.equals("recv")) {
                    temp.append("recv");
                    if(!tfResponse.getText().isEmpty())
                        temp.append(" response=\"").append(tfResponse.getText()).append("\"");
                    if(!tfRequest.getText().isEmpty())
                        temp.append(" request=\"").append(tfRequest.getText()).append("\"");
                    if(cbOptional.isSelected())
                        temp.append(" optional=\"true\"");
                    if(cbCrlf[1].isSelected())
                        temp.append(" crlf=\"true\"");
                    if(cbRrs.isSelected())
                        temp.append(" rrs=\"true\"");
                    if(cbAuth.isSelected())
                        temp.append(" auth=\"true\"");
                    if(!tfStartRtd[1].getText().isEmpty())
                        temp.append(" start_rtd=\"").append(tfStartRtd[1].getText()).append("\"");
                    if(!tfRtd[1].getText().isEmpty())
                        temp.append(" rtd=\"").append(tfRtd[1].getText()).append("\"");
                    if(cbRepeatRtd[1].isSelected())
                        temp.append(" repeat_rtd=\"true\"");
                    if(!tfLost[1].getText().isEmpty())
                        temp.append(" lost=\"").append(tfLost[1].getText()).append("\"");
                    if(!tfTimeout.getText().isEmpty())
                        temp.append(" timeout=\"").append(tfTimeout.getText()).append("\"");
                    if(!tfOnTimeout.getText().isEmpty())
                        temp.append(" ontimeout=\"").append(tfOnTimeout.getText()).append("\"");
                    if(!tfNext[1].getText().isEmpty())
                        temp.append(" next=\"").append(tfNext[1].getText()).append("\"");
                    if(!tfTest[1].getText().isEmpty())
                        temp.append(" test=\"").append(tfTest[1].getText()).append("\"");
                    if(!tfChance.getText().isEmpty())
                        temp.append(" chance=\"").append(tfChance.getText()).append("\"");
                    if(!tfCounter[1].getText().isEmpty())
                        temp.append(" counter=\"").append(tfCounter[1].getText()).append("\"");
                    if(cbRegexMatch.isSelected())
                        temp.append(" regexp_match=\"true\"");
                    if(!tfResponseTxn.getText().isEmpty())
                        temp.append(" response_txn=\"").append(tfResponseTxn.getText()).append("\"");
                    if(!tfAddOptions[1].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[1].getText());
                    temp.append(">");
                    if(cbAction[0].isSelected()&&!regexps.contains("<action>"))
                        temp.append("\n    <action>\n    </action>\n  ");
                    else if(!cbAction[0].isSelected()&&regexps.contains("<action>"))
                        temp.append("</recv>");
                    ...
                    if(!tfID.getText().isEmpty())
                        temp.append(" id=\"").append(tfID.getText()).append("\"");
                    if(!tfAddOptions[5].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[5].getText());
                    temp.append(" />");
                }
                else if(tagName.equals("nop")) {
                    temp.append("nop");
                    if(!tfStartRtd[2].getText().isEmpty())
                        temp.append(" start_rtd=\"").append(tfStartRtd[2].getText()).append("\"");
                    if(!tfRtd[2].getText().isEmpty())
                        temp.append(" rtd=\"").append(tfRtd[2].getText()).append("\"");
                    if(!tfAddOptions[2].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[2].getText());
                    temp.append(">");
                    if(cbAction[1].isSelected())
                        temp.append("\n    <action>\n    </action>\n  ");
                }
                else if(tagName.equals("sendCmd")) {
                    temp.append("sendCmd");
                    if(!tfDest.getText().isEmpty())
                        temp.append(" src=\"").append(tfDest.getText()).append("\"");
                    if(!tfAddOptions[3].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[3].getText());
                    temp.append(">");
                }
                else if(tagName.endsWith("recvCmd")) {
                    temp.append("recvCmd");
                    if(!tfSrc.getText().isEmpty())
                        temp.append(" src=\"").append(tfSrc.getText()).append("\"");
                    if(!tfAddOptions[4].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[4].getText());
                    temp.append(">");
                    if(cbAction[2].isSelected())
                        temp.append("\n    <action>\n    </action>\n  ");
                } else if(tagName.endsWith("action")) {
                    temp.append("action");

                    if(!tfAddOptions[8].getText().isEmpty())
                        temp.append(" ").append(tfAddOptions[8].getText());
    ...
    private void getOptions() {
        if(tagName.equals("send")) {
            options.put("retrans", "");options.put("start_rtd", "");options.put("rtd", "");
            options.put("repeat_rtd", "");options.put("crlf", "");options.put("lost", "");
            options.put("next", "");options.put("test", "");options.put("counter", "");
            options.put("start_txn", "");
        }
        if(tagName.equals("recv")) {
            options.put("response", "");options.put("request", "");options.put("optional", "");
            options.put("crlf", "");options.put("rrs", "");options.put("auth", "");
            options.put("start_rtd", "");options.put("rtd", "");options.put("repeat_rtd", "");
            options.put("lost", "");options.put("timeout", "");options.put("ontimeout", "");
            options.put("action", "");options.put("test", "");options.put("next", "");
            options.put("chance", "");options.put("counter", "");options.put("regexp_match", "");
            options.put("response_txn", "");
        }
        if(tagName.equals("pause")) {
            options.put("milliseconds", "");options.put("variable", "");options.put("distribution", "");
            options.put("crlf", "");options.put("next", "");options.put("sanity_check", "");
            options.put("value", "");options.put("min", "");options.put("max", "");
            options.put("mean", "");options.put("stdev", "");options.put("lambda", "");
            options.put("k", "");options.put("x_m", "");options.put("theta", "");
            options.put("p", "");options.put("n", "");
        }
        if(tagName.equals("nop")) {
            options.put("action", "");options.put("start_rtd", "");options.put("rtd", "");
        }
        if(tagName.equals("sendCmd")) {
            options.put("dest","");
        }
        if(tagName.equals("recvCmd")) {
            options.put("action", "");options.put("src", "");
        }
        ...
        while(st.hasMoreTokens()) {
            ...
            if(!Character.isLetter(key.toCharArray()[0]))
                continue;
